...
* [How to use local fonts](http://www.w3schools.com/css/css3_fonts.asp)
...
* Go to [this location](https://github.com/bapplejax/HTMLIntroductory/tree/master/archives/07-08/exercise).
* Download the "BELL.TTF" file to a new folder in your project called "fonts".
* Use the @font-face declaration in your css like this:
